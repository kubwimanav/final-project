            ...
            >
              ...
              <div className="p-4">
                ...
                <a
                  ...
                  className="mt-2 inline-flex items-center justify-center w-full py-2 px-4 bg-[#1fad9f] hover:bg-gray-600 text-sm text-white cursor-pointer font-medium rounded-lg transition-colors duration-200"
                >
                  Claim Item
                </a>
              </div>
